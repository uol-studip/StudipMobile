...
class StudipMobile extends StudipPlugin implements SystemPlugin
{
    ...
    private function redirectToMobile()
    {
        ...
        $url = PluginEngine::getLink($this, null, '');
